...
if [ "$COMPILE_ONLY" = true ]; then
  ...
  zip -Ar0 OUTPUT/aow2.3_code_r$vardate.pk3 cvarinfo.txt decorate.txt gameinfo.txt keyconf.txt main_changelog.txt gldefs.txt language.txt loadacs.txt teaminfo.txt scorinfo.txt menudef.txt acs/* source/* actors/* credits/*
